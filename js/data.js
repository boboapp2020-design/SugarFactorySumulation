...
const EMERGENCIES = [
  ...
  { id: 'injury', icon: '🚑', name: 'อุบัติเหตุจากการทำงาน', p: 0.012,
    ...
    options: [
      ...
      { label: 'ปฐมพยาบาล แล้วเดินเครื่องต่อ', cost: 50_000, hours: 1, rep: -4, riskFine: 0.45, fine: 2_400_000, staff: -12, labourComplaint: 1,
        desc: 'เร็วและถูก แต่เสี่ยงถูกกรมสวัสดิการฯ ปรับ ฿2.4 ล้าน (45%) ขวัญกำลังใจตกหนัก' },
    ] },
...
/* =====================================================================
   ตัวชี้วัดผลงาน 7 ด้าน (แสดงสด + ใช้ตัดเกรดตอนจบฤดู)
   ===================================================================== */
...
const SCORE_SPEC = [
  { key: 'profit',     icon: '💰', name: 'กำไร',                w: 280, tip: 'กำไรสุทธิทั้งฤดูเทียบเป้า ฿200 ล้าน (สำคัญอันดับ 1)' },
  { key: 'mgmt',       icon: '🎯', name: 'ประสิทธิภาพโรงงาน',   w: 180, tip: 'ปริมาณอ้อยเข้าหีบ (เป้า 700,000 ต) · เดินเครื่องต่อเนื่อง · คอขวดสมดุล · ไม่เสียอ้อย · หนี้น้อย' },
  { key: 'production', icon: '🏭', name: 'คุณภาพการผลิตน้ำตาล',  w: 180, tip: 'Recovery · Extraction · BHR · Undetermined loss' },
  { key: 'growerSat',  icon: '🌾', name: 'คุณภาพอ้อย/ชาวไร่',    w: 120, tip: 'ราคารับซื้อ · ลดคิวรอ · ไม่เสียอ้อยให้คู่แข่ง · ดูแลชาวไร่ประจำ' },
  { key: 'custSat',    icon: '🤝', name: 'ความพึงพอใจลูกค้า',    w: 100, tip: 'ส่งครบ ตรงเวลา คุณภาพคงที่' },
  { key: 'staffSat',   icon: '👷', name: 'ความพึงพอใจพนักงาน',   w: 90,  tip: 'ค่าจ้าง สวัสดิการ ภาระ OT ความปลอดภัย' },
