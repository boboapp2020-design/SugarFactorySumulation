...
const DEPTS = [
  ...
  },
  {
    ...
    levels: [
      ...
      { name: 'CE 67 bar + ระบบขายไฟ SPP',            cost: 17_600_000, kwh: 160, aux: 26 },
      { name: 'CE 2 ชุด + ควบคุมโหลดอัตโนมัติ',        cost: 24_200_000, kwh: 185, aux: 25 },
    ],
  },
  ...
  {
    id: 'ert', no: 15, icon: '🦺', name: 'ทีมความปลอดภัย & ฉุกเฉิน (จป.)', short: 'จป./ฉุกเฉิน',
    kind: 'support', group: 'support', maxStar: 3,
    role: 'จป./คปอ. ประเมินความเสี่ยง อบรมความปลอดภัย ตรวจการ์ดเครื่อง · ดับเพลิง · อุบัติเหตุ · บ่อบำบัดล้น — ยิ่งลงทุนยิ่งยกดัชนีความปลอดภัยและลดโอกาสเกิดเหตุ',
    metric: 'ดัชนีความปลอดภัย · เวลาแก้ไข · ค่าใช้จ่ายเมื่อเกิดเหตุ · โอกาสเกิดเหตุ',
    /* time = ตัวคูณเวลาแก้ไข · cost = ตัวคูณค่าเสียหาย · prob = ตัวคูณโอกาสเกิด */
    levels: [
      { name: 'ไม่มี จป./ทีมฉุกเฉิน (ผิดกฎหมาย เรียกหน่วยงานภายนอก)', cost: 0,          time: 1.00, cost_: 1.00, prob: 1.00 },
      { name: 'จป.วิชาชีพ + คปอ. + ทีมดับเพลิงอาสา 8 คน',            cost: 3_300_000,  time: 0.70, cost_: 0.75, prob: 0.82 },
      { name: 'ระบบ ISO 45001 + รถดับเพลิง + ห้องพยาบาล + รถพยาบาล',  cost: 7_500_000,  time: 0.48, cost_: 0.55, prob: 0.64 },
      { name: 'ศูนย์ความปลอดภัย 24 ชม. + ดับเพลิงอัตโนมัติ + Safety Culture (BBS)', cost: 13_000_000, time: 0.28, cost_: 0.36, prob: 0.46 },
    ],
  },
  {
  ...
  },
  {
    ...
    levels: [
      ...
      { name: 'UASB + ผลิตก๊าซชีวภาพ',                 cost: 6_100_000, pond: 18000, rate: 4600,  bod: 20 },
